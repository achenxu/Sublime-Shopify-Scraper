...
while True:
    ...
    for site in sites:
        data2 = request.get(site + 'products.json').json()
        ...
        print("\033[1;36m[LOG]\033[0m Checking Site! " + site)
        print("\033[1;36m[LOG]\033[0m Site Checked!")
